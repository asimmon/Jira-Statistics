...
public class JiraIssuesWriter : IDisposable
{
    ...
    private sealed class WorksheetWriter<T>
    {
        ...
        public void WriteCell(int fromRow, int fromCol, int toRow, int toCol, DateTime? value)
        {
            this.Write(fromRow, fromCol, toRow, toCol, value, "yyyy-MM-dd hh:mm:ss");
        }

        public void WriteCell(int row, int col, DateTime? value)
        {
            this.WriteCell(row, col, row, col, value);
        }

        public void WriteCell(int fromRow, int fromCol, int toRow, int toCol, double? value)
        {
        ...
        public void WriteCell(int fromRow, int fromCol, int toRow, int toCol, int? value)
        {
